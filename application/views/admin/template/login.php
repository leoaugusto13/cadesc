...
<head>
  ...
  <title>Log in | Cadastro de Escolas e Prédios</title>
  ...
  <link rel="stylesheet" href="<?php echo base_url ('public/dist/iCheck/square/blue.css')?>">
...
<div class="login-box">
  ...
  <div class="login-box-body">
    ...
    <a href="" class="text-center">Registrar um Novo Usuário</a>
...
<!-- iCheck -->
<script src="<?php echo base_url('public/dist/iCheck/icheck.min.js')?>"></script>
<script>
  $(function () {
    $('input').iCheck({
